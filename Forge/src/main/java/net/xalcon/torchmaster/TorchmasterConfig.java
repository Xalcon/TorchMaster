...
public class TorchmasterConfig
{
    ...
    public static final ITorchmasterConfig ConfigWrapper = new ITorchmasterConfig()
    {
        @Override
        public int getFeralFlareTickRate()
        {
            return TorchmasterConfig.GENERAL.feralFlareTickRate.get();
        }

        @Override
        public int getFeralFlareLanternLightCountHardcap()
        {
            return TorchmasterConfig.GENERAL.feralFlareLanternLightCountHardcap.get();
        }

        @Override
        public int getFeralFlareRadius()
        {
            return TorchmasterConfig.GENERAL.feralFlareRadius.get();
        }

        @Override
        public int getFeralFlareMinLightLevel()
        {
            return TorchmasterConfig.GENERAL.feralFlareMinLightLevel.get();
        }

        @Override
        public int getDreadLampRadius()
        {
            return TorchmasterConfig.GENERAL.dreadLampRadius.get();
        }
