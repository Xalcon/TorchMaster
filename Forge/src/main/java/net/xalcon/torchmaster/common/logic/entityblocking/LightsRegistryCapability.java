...
{
    private IBlockingLightRegistry container = new RegistryContainer();
    /**
    ...
    private static class RegistryContainer implements IBlockingLightRegistry
    {
        ...
        public CompoundTag serializeNBT()
        {
            ...
            for(HashMap.Entry<String, IEntityBlockingLight> lightEntry : lights.entrySet())
            {
                ...
                {
                    Constants.LOG.error("Unable to serialize light '{}', the serializer was null", lightKey);
                    continue;
                }
                ...
                if(serializer == null)
                {
                    Constants.LOG.error("Unable to serialize light '{}', the serializer '{}' was not found", lightKey, serializerKey);
                    continue;
                }
                ...
                try
                {
                    ...
                    if(lightNbt == null)
                    {
                        Constants.LOG.error("Unable to serialize light '{}', the serializer '{}' returned null", lightKey, serializerKey);
                        continue;
                    }
                ...
                {
                    Constants.LOG.error("The serializer '{}' threw an error during serialization!", serializerKey);
                    Constants.LOG.error("Exception:", ex);
                }
            }
        ...
        public void deserializeNBT(CompoundTag nbt)
        {
            ...
            for(String lightKey : nbt.getAllKeys())
            {
                ...
                if(serializer == null)
                {
                    Constants.LOG.error("Unable to deserialize the light '{}', the serializer '{}' was not found", lightKey, serializerKey);
                    continue;
                }
                ...
                try
                {
                    ...
                    if(light == null)
                    {
                        Constants.LOG.error("Unable to deserialize the light '{}', the serializer returned null", lightKey);
                        continue;
                    }
                ...
                {
                    Constants.LOG.error("The serializer '{}' threw an error during deserialization!", serializerKey);
                    Constants.LOG.error("Exception:", ex);
                }
            }
        }
